...
<body>
    <div class="container">
        ...
        <div class="details">
            <p><strong>Username/Email:</strong> <?php echo e($user->username); ?> or <?php echo e($user->email); ?></p>
            <p><strong>New Password:</strong> <?php echo e($new_password); ?></p>
        </div>
...
<?php /**PATH C:\laragon\www\mcmastery\resources\views\email-templates\password-changes-template.blade.php ENDPATH**/ ?>