...
<?php endif; ?>
        ...
        <div class="mb-3">
            <img class="profile-image"
                ...
                alt="<?php echo e($getRecord->name ?? 'Default Admin'); ?>">
        </div>

        <!-- Edit Profile Form -->
        <form class="forms-sample" action="<?php echo e(route('admin.update')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mcmastery\resources\views\admin\profile.blade.php ENDPATH**/ ?>