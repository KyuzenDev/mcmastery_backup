...
<?php endif; ?>
        ...
        <div class="mb-3">
            <img class="profile-image"
                ...
                alt="<?php echo e($getRecord->name ?? 'Default User'); ?>">
        </div>


        <form class="forms-sample" action="<?php echo e(route('user.update')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" value="<?php echo e($getRecord->username); ?>"
                    readonly>
            </div>
            <div class="mb-3">
...
<?php echo $__env->make('user.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mcmastery\resources\views/user/profile.blade.php ENDPATH**/ ?>