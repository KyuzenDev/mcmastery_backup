            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    ...
                    <img class="profile-image-small"
                        ...
                        alt="<?php echo e(Auth::user()->name ?? 'Default Admin'); ?>">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2">
                            <a href="<?php echo e(route('admin.profile')); ?>" class="text-body ms-0">
...
<?php /**PATH C:\laragon\www\mcmastery\resources\views/admin/body/header.blade.php ENDPATH**/ ?>