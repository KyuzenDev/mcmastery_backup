                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <form action="{{ url('admin/email/composePost') }}" method="post">
                                    <div class="p-3 pb-0">
                                        <div class="to">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="compose-multiple-select form-select" name="email">
                                                        <option value="-">Select Email [Seller & User]</option>
                                    ...
                                    <div class="px-3">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden" for="easyMdeEditor">Descriptions
                                                </label>
                                                <textarea class="form-control" name="descriptions" id="easyMdeEditor" rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="col-md-12">
